...
EnemyBossRightWeapon::EnemyBossRightWeapon() :
	m_model(-1),
...
void EnemyBossRightWeapon::Init()
{
	Collidable::Init();
	m_rigidbody.Init();
...
void EnemyBossRightWeapon::IdleUpdate(int model)
{
	// 当たり判定を無効化する
	SetActive(false);
...
void EnemyBossRightWeapon::AttackUpdate(int model)
{
	// 当たり判定を有効化する
	SetActive(true);
...
void EnemyBossRightWeapon::Draw()
{

...
EnemyBossLeftAxe::EnemyBossLeftAxe() :
	m_model(-1),
...
void EnemyBossLeftAxe::Update(int model, float currentFrame, const LeftAttackTiming& timing)
{
...
void EnemyBossLeftAxe::IdleUpdate(int model)
{
	// 当たり判定を無効化する
	SetActive(false);
...
void EnemyBossLeftAxe::AttackUpdate(int model)
{
	// 当たり判定を有効化する
	SetActive(true);
...
void EnemyBossLeftAxe::Draw()
{
	MV1DrawModel(m_model);
}

void EnemyBossLeftAxe::OnCollide(std::shared_ptr<Collidable> collider)
{
}
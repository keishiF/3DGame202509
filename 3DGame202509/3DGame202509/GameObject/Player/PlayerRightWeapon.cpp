...
void PlayerRightWeapon::Update(int model, float currentFrame, const RightAttackTiming& timing, bool specialFlag)
{
...
void PlayerRightWeapon::SpecialUpdate(int model)
{
	// 当たり判定を有効化する
	SetActive(true);
